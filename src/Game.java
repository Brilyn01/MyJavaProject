 ...
 static int Monster;
    ...
    static void battle_monster() {
        ...
        while (monster_health > 0 && Health > 0) {
            ...
            if (select.equals("nuski") || select.equals("rotwithmy9mm") || select.equals("vonski")) {
            ...
            if (select.equals("1")) {
                ...
                if (monster_health > 0) {
                    ...
                    if (isUntouchable) {
                        ...
                        System.out.println(MonsterName()+" hits you for " + monsterDamage + "! Your health: " + Health);
                    }
                }
    ...
    static void use_item() {
        ...
        switch (item) {
            case "potion":
                ...
                System.out.println("You drink the potion. +20 HP! Current health: " + Health);
                break;
            case "shield":
